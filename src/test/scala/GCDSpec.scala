// Taken from https://github.com/chipsalliance/chisel-template/blob/main/src/test/scala/gcd/GCDSpec.scala
...
/**
  ...
  * }}}
  */
class GCDSpec extends AnyFreeSpec with Matchers with ChiselScalatestTester {
