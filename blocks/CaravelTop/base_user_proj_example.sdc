...
set_input_delay -max 3.89 -clock [get_clocks {clk}] [get_ports {wb_adr[*]}]
...
set_input_delay -min 0.79 -clock [get_clocks {clk}] [get_ports {wb_adr[*]}]
...
set_input_transition -max 0.92  [get_ports {wb_adr[*]}]
set_input_transition -min 0.05  [get_ports {io_in[*]}]
set_input_transition -min 0.07  [get_ports {wb_adr[*]}]
