...
It includes a Chisel top-level module (`CaravelUserProject`) containing a simple GCD calculator which is connected to the Caravel's wishbone bus and GPIOs. The verilog for the `CaravelUserProject` module is generated by running:
