...
# Reset input delay
set_input_delay [expr $::env(CLOCK_PERIOD) * 0.5] -clock [get_clocks {clk}] [get_ports {reset}]

# Multicycle paths
set_multicycle_path -setup 2 -through [get_ports {wb_ack}]
set_multicycle_path -hold 1  -through [get_ports {wb_ack}]
set_multicycle_path -setup 2 -through [get_ports {wb_cyc}]
set_multicycle_path -hold 1  -through [get_ports {wb_cyc}]
set_multicycle_path -setup 2 -through [get_ports {wb_stb}]
set_multicycle_path -hold 1  -through [get_ports {wb_stb}]
...
# Input delays
set_input_delay -max 3.17 -clock [get_clocks {clk}] [get_ports {wb_sel[*]}]
set_input_delay -max 3.74 -clock [get_clocks {clk}] [get_ports {wb_we}]
set_input_delay -max 3.89 -clock [get_clocks {clk}] [get_ports {wb_addr[*]}]
set_input_delay -max 4.13 -clock [get_clocks {clk}] [get_ports {wb_stb}]
set_input_delay -max 4.61 -clock [get_clocks {clk}] [get_ports {wb_wrData[*]}]
set_input_delay -max 4.74 -clock [get_clocks {clk}] [get_ports {wb_cyc}]
set_input_delay -min 0.79 -clock [get_clocks {clk}] [get_ports {wb_addr[*]}]
set_input_delay -min 1.04 -clock [get_clocks {clk}] [get_ports {wb_wrData[*]}]
set_input_delay -min 1.19 -clock [get_clocks {clk}] [get_ports {wb_sel[*]}]
set_input_delay -min 1.65 -clock [get_clocks {clk}] [get_ports {wb_we}]
set_input_delay -min 1.69 -clock [get_clocks {clk}] [get_ports {wb_cyc}]
set_input_delay -min 1.86 -clock [get_clocks {clk}] [get_ports {wb_stb}]
if { $::env(IO_SYNC) } {
	set in_ext_delay 4
...
# Input Transition
set_input_transition -max 0.14  [get_ports {wb_we}]
set_input_transition -max 0.15  [get_ports {wb_stb}]
set_input_transition -max 0.17  [get_ports {wb_cyc}]
set_input_transition -max 0.18  [get_ports {wb_sel[*]}]
set_input_transition -max 0.38  [get_ports {io_in[*]}]
set_input_transition -max 0.84  [get_ports {wb_wrData[*]}]
set_input_transition -max 0.92  [get_ports {wb_addr[*]}]
set_input_transition -min 0.05  [get_ports {io_in[*]}]
set_input_transition -min 0.07  [get_ports {wb_addr[*]}]
set_input_transition -min 0.07  [get_ports {wb_wrData[*]}]
set_input_transition -min 0.09  [get_ports {wb_cyc}]
set_input_transition -min 0.09  [get_ports {wb_sel[*]}]
set_input_transition -min 0.09  [get_ports {wb_we}]
set_input_transition -min 0.15  [get_ports {wb_stb}]

# Output delays
set_output_delay -max 3.62 -clock [get_clocks {clk}] [get_ports {wb_rdData[*]}]
set_output_delay -max 8.41 -clock [get_clocks {clk}] [get_ports {wb_ack}]
set_output_delay -min 1.13 -clock [get_clocks {clk}] [get_ports {wb_rdData[*]}]
set_output_delay -min 1.37 -clock [get_clocks {clk}] [get_ports {wb_ack}]
if { $::env(IO_SYNC) } {
	set out_ext_delay 4
