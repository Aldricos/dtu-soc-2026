...
set_input_delay -max 4.61 -clock [get_clocks {clk}] [get_ports {wb_din[*]}]
...
set_input_delay -min 1.04 -clock [get_clocks {clk}] [get_ports {wb_din[*]}]
...
set_input_transition -max 0.84  [get_ports {wb_din[*]}]
...
set_input_transition -min 0.07  [get_ports {wb_din[*]}]
...
# Output delays
set_output_delay -max 3.62 -clock [get_clocks {clk}] [get_ports {wb_dout[*]}]
set_output_delay -max 8.41 -clock [get_clocks {clk}] [get_ports {wb_ack}]
set_output_delay -min 1.13 -clock [get_clocks {clk}] [get_ports {wb_dout[*]}]
